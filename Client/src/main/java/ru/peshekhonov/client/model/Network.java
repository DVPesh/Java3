...
public class Network {
    ...
    public void sendUsernameChangeMessage(String login, String password, String username) throws IOException {
        sendCommand(Command.changeUsernameCommand(login, password, username));
    }
    ...
    public void sendEndCommand() throws IOException {
    ...
    public boolean isReadMessageListenerPresent(ReadCommandListener listener) {
